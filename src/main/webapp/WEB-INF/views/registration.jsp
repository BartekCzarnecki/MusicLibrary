    ...
    <div class="container pt-4 pb-4">
        <div class="border-dashed view-height">
            <div class="container w-25">
                ...
                <form:form class="padding-small text-center" action="/user/add" method="post" modelAttribute="user">
                    ...
                    <div class="form-group">
                        <form:input path="login" type="text" class="form-control" id="login" name="login" placeholder="podaj login"/>
